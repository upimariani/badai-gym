...
<head>
	...
	<title>REGISTRASI PELANGGAN - BADAI GYM</title>
			...
			<div class="container">
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Register Pelanggan</h2>
						...
						?>
							<div class="alert alert-success alert-dismissible fade show" role="alert">
								<strong>Gagal!</strong> <?= $this->session->userdata('success') ?>
							</div>
						<?php
						}
						?>
					...
					<div class="signup-image">
						...
						<a href="<?= base_url('Frontend/cLogin') ?>" class="signup-image-link">Sudah memiliki akun?</a>
					</div>
				</div>
			</div>
		</section>
