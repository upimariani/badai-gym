						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									<form action="<?= base_url('Backend/cDiskon/update/' . $diskon->id_diskon) ?>" method="POST">
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="paket" class="form-control">
													...
													?>
														<option value="<?= $value->id_paket ?>" <?php if ($diskon->id_paket == $value->id_paket) {
																									echo 'selected';
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" value="<?= $diskon->nama_diskon ?>" name="nama" class="form-control" placeholder="Masukkan Nama Diskon">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" value="<?= $diskon->deskripsi ?>" name="deskripsi" class="form-control" placeholder="Masukkan Deskripsi">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" value="<?= $diskon->disc ?>" name="diskon" class="form-control" placeholder="Masukkan Diskon (%)">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<select name="level_member" class="form-control">
													...
													<option <?php if ($diskon->lev_member == '1') {
																echo 'selected';
															} ?> value="1">Classic</option>
													<option <?php if ($diskon->lev_member == '2') {
																echo 'selected';
															} ?> value="2">Silver</option>
													<option <?php if ($diskon->lev_member == '3') {
																echo 'selected';
															} ?> value="3">Gold</option>
