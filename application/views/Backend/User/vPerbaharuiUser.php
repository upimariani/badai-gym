						...
						<div class="col-sm-12">
							...
							<div class="card">
								...
								<div class="card-block">
									<form action="<?= base_url('Backend/cUser/update/' . $user->id_user) ?>" method="POST">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" value="<?= $user->alamat ?>" name="alamat" class="form-control" placeholder="Masukkan Alamat">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="number" value="<?= $user->no_hp ?>" name="no_hp" class="form-control" placeholder="Masukkan Nomor Telepon">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input type="text" value="<?= $user->password ?>" name="password" class="form-control" placeholder="Masukkan Password">
